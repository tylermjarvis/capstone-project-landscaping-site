...
const Chatbot = () => {
  useEffect(() => {
    ...
    //     } else if (
    //       questionTwo.some((word) => changeToLowerCase.includes(word))
    //     ) {
    ...
    //     } else if (
    //       questionThree.some((word) => changeToLowerCase.includes(word))
    //     ) {
    ...
    //     } else if (
    //       questionFour.some((word) => changeToLowerCase.includes(word))
    //     ) {
    ...
    //     } else if (
    //       questionFive.some((word) => changeToLowerCase.includes(word))
    //     ) {
    ...
    //     } else if (
    //       questionSix.some((word) => changeToLowerCase.includes(word))
    //     ) {
    ...
    //     } else if (
    //       questionSeven.some((word) => changeToLowerCase.includes(word))
    //     ) {
    ...
    //     } else if (
    //       questionEight.some((word) => changeToLowerCase.includes(word))
    //     ) {
    ...
    //     } else if (
    //       questionNine.some((word) => changeToLowerCase.includes(word))
    //     ) {
    ...
    //     } else if (
    //       questionTen.some((word) => changeToLowerCase.includes(word))
    //     ) {
    ...
    script.src =
      "https://github.com/tylermjarvis/capstone-project-landscaping-site/blob/main/capstone-project/src/js/chat-bot.js";
    script.type = "module";
    script.defer = true;
